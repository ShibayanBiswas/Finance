...
final_stats_df["TEV"] =  transpose_df["MarketCap"].fillna(0) + transpose_df["TotDebt"].fillna(0) + transpose_df["PrefStock"].fillna(0) + transpose_df["MinInterest"].fillna(0) - (transpose_df["CurrAsset"].fillna(0)-transpose_df["CurrLiab"].fillna(0))
...
final_stats_df["CombRank"] = final_stats_df["EarningYield"].rank(ascending=False,method='first')+final_stats_df["ROC"].rank(ascending=False,method='first')+final_stats_df["DivYield"].rank(ascending=False,method='first')
